...
import taskmanager.services.exception.NoSuchTaskException;
import taskmanager.services.model.Task;
import taskmanager.services.model.impl.TaskImpl;
import taskmanager.services.model.impl.TaskModelImpl;
import taskmanager.services.service.persistence.TaskPersistence;
import taskmanager.services.service.persistence.impl.constants.TMPersistenceConstants;
...
public class TaskPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByGroupIdCompanyIdUserId;
	private FinderPath _finderPathWithoutPaginationFindByGroupIdCompanyIdUserId;
	private FinderPath _finderPathCountByGroupIdCompanyIdUserId;

	/**
	 * Returns all the tasks where groupId = &#63; and companyId = &#63; and userId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public List<Task> findByGroupIdCompanyIdUserId(
		long groupId, long companyId, long userId) {

		return findByGroupIdCompanyIdUserId(
			groupId, companyId, userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the tasks where groupId = &#63; and companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>TaskModelImpl</code>.
	 * </p>
	...
	public List<Task> findByGroupIdCompanyIdUserId(
		...
		return findByGroupIdCompanyIdUserId(
			groupId, companyId, userId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the tasks where groupId = &#63; and companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>TaskModelImpl</code>.
	 * </p>
	...
	public List<Task> findByGroupIdCompanyIdUserId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByGroupIdCompanyIdUserId;
				finderArgs = new Object[] {groupId, companyId, userId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByGroupIdCompanyIdUserId;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUPIDCOMPANYIDUSERID_GROUPID_2);

			sb.append(_FINDER_COLUMN_GROUPIDCOMPANYIDUSERID_COMPANYID_2);

			sb.append(_FINDER_COLUMN_GROUPIDCOMPANYIDUSERID_USERID_2);
	...
	/**
	 * Returns the first task in the ordered set where groupId = &#63; and companyId = &#63; and userId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param userId the user ID
	 ...
	 */
	@Override
	public Task findByGroupIdCompanyIdUserId_First(
			long groupId, long companyId, long userId,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByGroupIdCompanyIdUserId_First(
	 ...
	 */
	@Override
	public Task fetchByGroupIdCompanyIdUserId_First(
		long groupId, long companyId, long userId,
		OrderByComparator<Task> orderByComparator) {

		List<Task> list = findByGroupIdCompanyIdUserId(
	...
	/**
	 * Returns the last task in the ordered set where groupId = &#63; and companyId = &#63; and userId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param userId the user ID
	 ...
	 */
	@Override
	public Task findByGroupIdCompanyIdUserId_Last(
			long groupId, long companyId, long userId,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {

		Task task = fetchByGroupIdCompanyIdUserId_Last(
			groupId, companyId, userId, orderByComparator);
	 ...
	 */
	@Override
	public Task fetchByGroupIdCompanyIdUserId_Last(
		long groupId, long companyId, long userId,
		OrderByComparator<Task> orderByComparator) {

		int count = countByGroupIdCompanyIdUserId(groupId, companyId, userId);
	...
	/**
	 * Returns the tasks before and after the current task in the ordered set where groupId = &#63; and companyId = &#63; and userId = &#63;.
	 *
	 * @param taskId the primary key of the current task
	 * @param groupId the group ID
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public Task[] findByGroupIdCompanyIdUserId_PrevAndNext(
			long taskId, long groupId, long companyId, long userId,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {
		...
		try {
			...
			array[0] = getByGroupIdCompanyIdUserId_PrevAndNext(
				session, task, groupId, companyId, userId, orderByComparator,
				true);

			array[1] = task;

			array[2] = getByGroupIdCompanyIdUserId_PrevAndNext(
				session, task, groupId, companyId, userId, orderByComparator,
				false);
	...
	protected Task getByGroupIdCompanyIdUserId_PrevAndNext(
		Session session, Task task, long groupId, long companyId, long userId,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the tasks where groupId = &#63; and companyId = &#63; and userId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param userId the user ID
	 */
	@Override
	public void removeByGroupIdCompanyIdUserId(
		long groupId, long companyId, long userId) {
	...
	/**
	 * Returns the number of tasks where groupId = &#63; and companyId = &#63; and userId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param userId the user ID
	 ...
	 */
	@Override
	public int countByGroupIdCompanyIdUserId(
		long groupId, long companyId, long userId) {

		FinderPath finderPath = _finderPathCountByGroupIdCompanyIdUserId;
	...
	private static final String
		_FINDER_COLUMN_GROUPIDCOMPANYIDUSERID_GROUPID_2 =
			"task.groupId = ? AND ";

	private static final String
		_FINDER_COLUMN_GROUPIDCOMPANYIDUSERID_COMPANYID_2 =
			"task.companyId = ? AND ";

	private static final String _FINDER_COLUMN_GROUPIDCOMPANYIDUSERID_USERID_2 =
		"task.userId = ?";
	...
	public Task updateImpl(Task task) {
		...
		if (isNew) {
			...
			args = new Object[] {
				taskModelImpl.getGroupId(), taskModelImpl.getCompanyId(),
				taskModelImpl.getUserId()
			};

			finderCache.removeResult(
				_finderPathCountByGroupIdCompanyIdUserId, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByGroupIdCompanyIdUserId, args);
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByGroupIdCompanyIdUserId = new FinderPath(
			TaskImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupIdCompanyIdUserId",
			new String[] {
		...
		_finderPathCountByGroupIdCompanyIdUserId = new FinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByGroupIdCompanyIdUserId",
			new String[] {
	...
	@Override
	@Reference(
		target = TMPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
