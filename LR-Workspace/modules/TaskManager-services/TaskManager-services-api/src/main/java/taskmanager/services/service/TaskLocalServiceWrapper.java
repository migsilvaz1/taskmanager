...
public class TaskLocalServiceWrapper
	 ...
	 */
	@Override
	public taskmanager.services.model.Task addTask(
	...
	@Override
	public taskmanager.services.model.Task checkDone(long taskId) {
		return _taskLocalService.checkDone(taskId);
	}
	...
	@Override
	public taskmanager.services.model.Task createTask() {
	 ...
	 */
	@Override
	public taskmanager.services.model.Task createTask(long taskId) {
	 ...
	 */
	@Override
	public taskmanager.services.model.Task deleteTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public taskmanager.services.model.Task deleteTask(
		taskmanager.services.model.Task task) {
	...
	@Override
	public taskmanager.services.model.Task fetchTask(long taskId) {
	 ...
	 */
	@Override
	public taskmanager.services.model.Task fetchTaskByUuidAndGroupId(
	...
	public java.util.List<taskmanager.services.model.Task> findByDone(
		...
		return _taskLocalService.findByDone(
			groupId, companyId, userId, start, end);
	}

	@Override
	public java.util.List<taskmanager.services.model.Task>
		findByGroupIdCompanyIdUserId(
			long groupId, long companyId, long userId, int start, int end) {

		return _taskLocalService.findByGroupIdCompanyIdUserId(
			groupId, companyId, userId, start, end);
	}
	...
	public java.util.List<taskmanager.services.model.Task> findByToDo(
		...
		return _taskLocalService.findByToDo(
			groupId, companyId, userId, start, end);
	}
	 ...
	 */
	@Override
	public taskmanager.services.model.Task getTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public taskmanager.services.model.Task getTaskByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<taskmanager.services.model.Task> getTasks(
		int start, int end) {
	...
	@Override
	public taskmanager.services.model.Task uncheckDone(long taskId) {
		return _taskLocalService.uncheckDone(taskId);
	}
	 ...
	 */
	@Override
	public taskmanager.services.model.Task updateTask(
		taskmanager.services.model.Task task) {
